...
@WebServlet("/myrecords/show")
public class MyRecordsShowServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public MyRecordsShowServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/records/my_show.jsp");
